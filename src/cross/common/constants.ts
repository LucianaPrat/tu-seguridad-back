...
export const EnvNames = {
  ...
  DVR_EVENTS_ENABLED: 'DVR_EVENTS_ENABLED',
  DVR_EVENTS_DEBOUNCE_SECONDS: 'DVR_EVENTS_DEBOUNCE_SECONDS',
  DVR_EVENTS_IDLE_SECONDS: 'DVR_EVENTS_IDLE_SECONDS',
  ...
  SNAPSHOT_KEEP_RAW: 'SNAPSHOT_KEEP_RAW',
  SNAPSHOT_KEEP_MISSES: 'SNAPSHOT_KEEP_MISSES',
  ENTER_HITS_REQUIRED: 'ENTER_HITS_REQUIRED',
  ENTER_WINDOW_POLLS: 'ENTER_WINDOW_POLLS',
...
export const ERROR_CODE_HTTP_STATUS: Record<ErrorCode, number> = {
  ...
  // Not 429: nothing this caller did was rate limited, the upstream we depend
  // on is unavailable to us for a known interval.
  [ErrorCode.UPSTREAM_THROTTLED]: 503,
