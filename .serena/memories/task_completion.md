...
2. If anything under `src/` changed, prefer a manual smoke check against the real
...
3. If a Prisma schema change was made: migration file committed under
...
4. If working from a numbered plan under `plans/`: update the companion
